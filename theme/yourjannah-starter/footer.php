...
// ── Superchat modal (global — used by mosque page, homepage, feed reply) ──
?>
<div class="ynj-hud-popup" id="ynj-superchat-popup" style="display:none;" onclick="if(event.target===this)ynjSuperchatClose()">
    <div class="ynj-hud-popup__card" style="max-width:380px;background:#fff;text-align:center;">
