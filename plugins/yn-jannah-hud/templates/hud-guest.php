...
<div class="ynj-hud" id="ynj-hud">
    <span style="font-size:16px;font-family:'Amiri','Traditional Arabic',serif;color:#fff;font-weight:700;letter-spacing:.5px;">السلام عليكم</span>
    <span style="font-size:10px;color:rgba(255,255,255,.5);font-weight:600;">Peace &amp; Blessings on You</span>
